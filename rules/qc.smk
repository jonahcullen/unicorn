...
rule fastqc:
    ...
    params:
        ...
        r1_html = lambda wildcards, input: os.path.basename(input.r1.replace(".fq.gz","_fastqc.html")),
        r1_zip  = lambda wildcards, input: os.path.basename(input.r1.replace(".fq.gz","_fastqc.zip")),
        r2_html = lambda wildcards, input: os.path.basename(input.r2.replace(".fq.gz","_fastqc.html")),
        r2_zip  = lambda wildcards, input: os.path.basename(input.r2.replace(".fq.gz","_fastqc.zip")),
    benchmark:
